...
BEGIN
    ...
    SELECT id INTO user1_id FROM users WHERE email = 'petugas1@bps-pematangsiantar.go.id';
    SELECT id INTO user2_id FROM users WHERE email = 'petugas2@bps-pematangsiantar.go.id';
